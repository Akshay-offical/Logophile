...
import 'package:logophile_final/profile/leftnavpage.dart';
...
class _ProfileUI2State extends State<ProfileUI2> {
  ...
  initSearch() async {
    ...
    await databaseMethods10
        .getUserrrrSpecificFeed(Constants.myName)
        .then((val) {
      if (this.mounted) {
        setState(() {
              ...
              child: GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => MyShelf()));
                  },
...
class feedTile extends StatefulWidget {
  ...
  final String tags;
  final String id;
  feedTile(this.userEmail, this.time, this.body,this.id, this.title, this.tags);
...
class _feedTileState extends State<feedTile> {
  ...
  deleteePost(String username,String id){
    // databaseMethods2.deletePost(username, id);
  }
  showAlertDialogBox(BuildContext context, String id) {
    ...
    Widget deleteButton = FlatButton(
      ...
      onPressed: () {
        deleteePost(Constants.myName,id);
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Delete this post from your Profile"),
      actions: [
        cancelbutton,
        deleteButton,
      ],
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  GestureDetector(
                    onLongPress: (){
                     //showAlertDialogBox(context,feedid);
                    },
                    child: Container(
                      decoration: BoxDecoration(
                          gradient: LinearGradient(
