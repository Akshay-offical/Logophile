...
import 'package:logophile_final/forums/forum_display.dart';
import 'package:logophile_final/helper/constants.dart';
import 'package:logophile_final/services/database.dart';

class SearchForums extends StatefulWidget {
  @override
  _SearchForumsState createState() => _SearchForumsState();
}

class _SearchForumsState extends State<SearchForums> {
            ...
            itemBuilder: (context, index) {
              if (searchSnapshot.docs[index]
                ...
                return Container(
                  ...
                  child: SearchTile(
                    forumName: searchSnapshot.docs[index].data()["forumName"],
                    // userEmail: searchSnapshot.docs[index].data()["email"],
                    image: searchSnapshot.docs[index].data()["displaypic"],
                  ),
                );
              else {
                x++;
  ...
  initiateSearch() {
    databaseMethods.getForumsOnSearch().then((val) {
      if(this.mounted){
      setState(() {
        searchSnapshot = val;
      });
  ...
  Widget SearchTile({String forumName, String userEmail, String image}) {
