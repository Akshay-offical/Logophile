...
class CommonShelfDetails extends StatefulWidget {
   final String shelf;
   final String userName;

  const CommonShelfDetails({Key key, this.shelf, this.userName}) : super(key: key);
  @override
  _CommonShelfDetailsState createState() => _CommonShelfDetailsState(shelf, userName);
}

class _CommonShelfDetailsState extends State<CommonShelfDetails> {
  String shelf;
  String userName;
  _CommonShelfDetailsState(this.shelf, this.userName);
  ...
  initiateSearch() {
    ...
    databaseMethods.getUserSpecificShelf(userName).then((val) {
       if (this.mounted) {
        setState(() {
          searchSnapshot = val;
        });
